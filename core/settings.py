...
CONFIG_REDIS_URL = config("CONFIG_REDIS_URL", default="")
...
CSRF_TRUSTED_ORIGINS = ['http://localhost:8000', 'http://127.0.0.1:8000', CONFIG_CSRF_TRUSTED_ORIGINS]
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "Adoção de Animais",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Adoção de Animais",

    # Logo to use for your site, must be present in static files, used for brand on top left
    #"site_logo": "books/img/logo.png",
    "site_logo": "icon/dog-icon.png",

    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    #"login_logo": None,
    "login_logo": "icon/dog-logo.jpg",
    ...
    "welcome_sign": "Bem Vindo ao Sistema de Gestão de Adoção de Animais",

    # Copyright on the footer
    "copyright": "Instituto Federal de Mato Grosso do Sul",
